...
from test_framework.xrayconfig import ENABLE_REDUCED_BLOCK_TIME

import sys


RPC_INVALID_PARAMETER = -8
class XrayRPCSearchlogsTestModified(BitcoinTestFramework):
...
if __name__ == '__main__':
    XrayRPCSearchlogsTestModified().main()