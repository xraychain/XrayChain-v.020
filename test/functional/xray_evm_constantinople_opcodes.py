...
class XrayEVMConstantinopleOpcodesTest(BitcoinTestFramework):
    ...
    def create2_test(self, should_fail):
        ...
        abi = "9fcc1813"
        abi += hex(0x20)[2:].zfill(64)
        abi += hex(len(bytecode) // 2)[2:].zfill(64)
        abi += bytecode
        self.send(abi)
        codehash = self.keccak256(bytecode)
...
if __name__ == '__main__':
    XrayEVMConstantinopleOpcodesTest().main()
