...
class XrayIgnoreMPOSParticipantRewardTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Only have staking outputs with nValue == 2400.0
        # Since the rest of the code relies on this
        i = 0
        while i < len(self.staking_prevouts):
            if self.staking_prevouts[i][1] != 2400*COIN:
...
if __name__ == '__main__':
    XrayIgnoreMPOSParticipantRewardTest().main()
