#ifndef XRAYVERSIONCHECKER_H
#define XRAYVERSIONCHECKER_H

#include <QObject>

#define XRAY_RELEASES "https://github.com/xrayproject/xray/releases"
...
class XrayVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit XrayVersionChecker(QObject *parent = 0);
    ~XrayVersionChecker();
