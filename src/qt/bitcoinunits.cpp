...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XRAY");
    case mBTC: return QString("mXRAY");
    case uBTC: return QString::fromUtf8("μXRAY (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Xrays");
    case mBTC: return QString("Milli-Xrays (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Xrays (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
