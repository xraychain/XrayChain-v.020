...
#define QAPP_ORG_NAME "Xray"
#define QAPP_ORG_DOMAIN "raychain.io"
#define QAPP_APP_NAME_DEFAULT "Xray-Qt"
#define QAPP_APP_NAME_TESTNET "Xray-Qt-testnet"
#define QAPP_APP_NAME_REGTEST "Xray-Qt-regtest"
