    ...
    walletFrame(qobject_cast<WalletFrame*>(parent))
{
    ...
    QPushButton *exportButton = new XrayPushButton(tr("&Export"), this);
    ...
    XRCTokenPage = new XRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    XRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    XRCTokenPage->setModel(_walletModel);
