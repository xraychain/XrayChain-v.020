...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("hashStateRoot", blockindex->hashStateRoot.GetHex()); // xray
    result.pushKV("hashUTXORoot", blockindex->hashUTXORoot.GetHex()); // xray

    if(blockindex->IsProofOfStake()){
        result.pushKV("prevoutStakeHash", blockindex->prevoutStake.hash.GetHex()); // xray
        result.pushKV("prevoutStakeVoutN", (int64_t)blockindex->prevoutStake.n); // xray
    }
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* tip, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.pushKV("hashStateRoot", block.hashStateRoot.GetHex()); // xray
    result.pushKV("hashUTXORoot", block.hashUTXORoot.GetHex()); // xray
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if xrayd is started with -deprecatedrpc=size\n"
...
UniValue getdelegationinfoforaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationinfoforaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The xray address string"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
    ...
    XrayDelegation xrayDelegation;
    Delegation delegation;
    uint160 address = uint160(*pkhash);
    if(!xrayDelegation.GetDelegation(address, delegation)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegation");
    }
    bool verified = xrayDelegation.VerifyDelegation(address, delegation);
...
UniValue getdelegationsforstaker(const JSONRPCRequest& request)
{
            RPCHelpMan{"getdelegationsforstaker",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The xray address string for staker"},
                },
               RPCResult{
            RPCResult::Type::ARR, "", "",
                {
    ...
    if(!xrayDelegation.FilterDelegationEvents(events, filter)) {
        throw JSONRPCError(RPC_INTERNAL_ERROR, "Failed to get delegations for staker");
    }
    std::map<uint160, Delegation> delegations = xrayDelegation.DelegationsFromEvents(events);
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of xray addresses",
                                    {{RPCResult::Type::STR, "address", "xray address"}}},
                            }},
...
static UniValue xrc20name(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20name",
                ...
                RPCExamples{
                    HelpExampleCli("xrc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("xrc20name", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue xrc20symbol(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20symbol",
                ...
                RPCExamples{
                    HelpExampleCli("xrc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("xrc20symbol", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue xrc20totalsupply(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20totalsupply",
                ...
                RPCExamples{
                    HelpExampleCli("xrc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("xrc20totalsupply", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue xrc20decimals(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20decimals",
                ...
                RPCExamples{
                    HelpExampleCli("xrc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
            + HelpExampleRpc("xrc20decimals", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\"")
                },
            }.Check(request);
...
static UniValue xrc20balanceof(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20balanceof",
                "\nReturns the token balance for address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO,  "The xray address to check token balance"},
                },
                RPCResult{
                    RPCResult::Type::STR, "balance", "The token balance of the chosen address"},
                RPCExamples{
                    HelpExampleCli("xrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("xrc20balanceof", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
                },
            }.Check(request);
...
static UniValue xrc20allowance(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20allowance",
                "\nReturns remaining tokens allowed to spend for an address\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address"},
                    {"addressFrom", RPCArg::Type::STR, RPCArg::Optional::NO,  "The xray address of the account owning tokens"},
                    {"addressTo", RPCArg::Type::STR, RPCArg::Optional::NO,  "The xray address of the account able to transfer the tokens"},
                },
                RPCResult{
                    RPCResult::Type::STR, "allowance", "Amount of remaining tokens allowed to spent"},
                RPCExamples{
                    HelpExampleCli("xrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
            + HelpExampleRpc("xrc20allowance", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" \"QM72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd\"")
                },
            }.Check(request);
...
static UniValue xrc20listtransactions(const JSONRPCRequest& request)
{
            RPCHelpMan{"xrc20listtransactions",
                "\nReturns transactions history for a specific address.\n",
                {
                    {"contractaddress", RPCArg::Type::STR_HEX, RPCArg::Optional::NO, "The contract address."},
                    {"addresss", RPCArg::Type::STR, RPCArg::Optional::NO,  "The xray address to get history for."},
            ...
            RPCResult::Type::ARR, "", "",
                {
                    {RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR, "receiver", "The receiver xray address"},
                            {RPCResult::Type::STR, "sender", "The sender xray address"},
                ...
                RPCExamples{
                    HelpExampleCli("xrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleCli("xrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
            + HelpExampleRpc("xrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\"")
            + HelpExampleRpc("xrc20listtransactions", "\"eb23c0b3e6042821da281a2e2364feb22dd543e3\" \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\" 0 6")
                },
            }.Check(request);
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "blockchain",         "xrc20name",              &xrc20name,              {"address"} },
    { "blockchain",         "xrc20symbol",            &xrc20symbol,            {"address"} },
    { "blockchain",         "xrc20totalsupply",       &xrc20totalsupply,       {"address"} },
    { "blockchain",         "xrc20decimals",          &xrc20decimals,          {"address"} },
    { "blockchain",         "xrc20balanceof",         &xrc20balanceof,         {"contractaddress", "address"} },
    { "blockchain",         "xrc20allowance",         &xrc20allowance,         {"contractaddress", "addressFrom", "addressTo"} },
    { "blockchain",         "xrc20listtransactions",  &xrc20listtransactions,  {"contractaddress", "address", "startblock", "minconf"} },
