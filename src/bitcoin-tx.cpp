...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " xray-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  xray-tx [options] <hex-tx> [commands]  Update hex-encoded xray transaction\n" +
            "or:     xray-tx [options] -create [commands]   Create hex-encoded xray transaction\n" +
            "\n";
