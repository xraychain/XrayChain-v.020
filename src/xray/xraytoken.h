...
public:
    ...
    void setXrayTokenExec(XrayTokenExec* tokenExec);
    ...
    // Static functions
    static bool ToHash160(const std::string& strXrayAddress, std::string& strHash160);
    static bool ToXrayAddress(const std::string& strHash160, std::string& strXrayAddress);
...
private:
    ...
    XrayToken(XrayToken const&);
    XrayToken& operator=(XrayToken const&);
