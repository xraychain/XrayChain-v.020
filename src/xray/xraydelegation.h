#ifndef XRAYDELEGATION_H
#define XRAYDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IXrayStaker class Delegation filter
 */
...
/**
 * @brief The XrayDelegation class Communicate with the xray delegation contract
 */
class XrayDelegation {
    
public:
    /**
     * @brief XrayDelegation Constructor
     */
    XrayDelegation();

    /**
     * @brief ~XrayDelegation Destructor
     */
    virtual ~XrayDelegation();
...
private:
    XrayDelegation(const XrayDelegation&);
    XrayDelegation& operator=(const XrayDelegation&);
    XrayDelegationPriv* priv;
};
#endif
