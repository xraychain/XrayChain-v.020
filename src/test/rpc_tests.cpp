...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(12000000024999990LL).write() == "120000000.24999990");
    BOOST_CHECK(ValueFromAmount(12000000024999999LL).write() == "120000000.24999999");
    BOOST_CHECK(ValueFromAmount(12000000025000000LL).write() == "120000000.25000000");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("120000000.2499999")), 12000000024999990LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("120000000.24999999")), 12000000024999999LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("120000000.25")), 12000000025000000LL);
