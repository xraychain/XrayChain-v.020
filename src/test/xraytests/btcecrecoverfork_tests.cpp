...
//    initState();
    ...
    std::vector<XrayTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createXrayTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createXrayTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createXrayTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createXrayTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
