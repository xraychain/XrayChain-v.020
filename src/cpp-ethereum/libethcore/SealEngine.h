...
////////////////////////////////////////////////////////////// // xray
    void setXraySchedule(EVMSchedule _xraySchedule) const { xraySchedule = _xraySchedule; }

    EVMSchedule& getXraySchedule() const { return xraySchedule; }
...
private:
    ...
    mutable EVMSchedule xraySchedule; // xray
