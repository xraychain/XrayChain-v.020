...
#include "genesis/xrayMainNetwork.cpp"
...
#include "genesis/test/xrayTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::xrayMainNetwork: return c_genesisInfoXrayMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::xrayTestNetwork: return c_genesisInfoXrayTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::xrayMainNetwork: return c_genesisStateRootXrayMainNetwork;
    case Network::xrayTestNetwork: return c_genesisStateRootXrayTestNetwork;
